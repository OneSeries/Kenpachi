...
struct KenpachiApp: App {
    ...
    private func setupApp() {
        ...
        AppLogger.shared.log("Kenpachi v\(AppConstants.App.version) (\(AppConstants.App.buildNumber)) launched", level: .info)
    }
    ...
    private func configureAppearance() {
        ...
        // Sets the background color of the tab bar with a slight transparency.
