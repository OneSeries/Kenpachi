...
struct GogoAnime: ScraperProtocol {
    ...
    func fetchContentDetails(id: String, type: ContentType?) async throws -> Content {
        ...
        let typeText = HTMLParser.extractText(from: doc, selector: ".anime_info_body_bg p.type:eq(0)")
        let yearText = HTMLParser.extractText(from: doc, selector: ".anime_info_body_bg p.type:eq(2)")
